...
This way you do not need any direct dependency to any `Activity` inside of your project to be able to navigate to it. You can just use one of the constants generated by Quadrant in the following way:
